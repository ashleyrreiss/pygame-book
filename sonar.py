...
range. For example, the C marks are where the chests are. The sonar device shows a 
...
while True:
    ...
    while sonarDevices > 0:
        ...
        print('You have %s sonar device(s) left. %s treature chest(s) remaining.' % (sonarDevices, len(theChests)))
